...
import com.example.agroclinic.databinding.ActivityTenthTableBinding;

import java.text.DecimalFormat;

public class TenthTableActivity extends AppCompatActivity {
    ActivityTenthTableBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_tenth_table);
        initView();
    }
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (!s.toString().isEmpty()) {
                    ...
                    if (binding.rbEkar.isChecked()) {
                        ...
                        Toast.makeText(TenthTableActivity.this, "कृपया एकक निवडा", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    binding.etLand.setText("0.0");
                }
    ...
    private void valueForCalculationOfGunta(String input) {
        ...
        //First Dose
        //First Dose
        double hundredKg = (2.66 * inputFromEditText);
    ...
    private void valueForCalculationOfHector(String input) {
        ...
        //Calculations for 15:15:15
        //First Dose
        double hundredKg = (266.67 * inputFromEditText);
        double hundredKgTwoDigits = Double.parseDouble(String.format("%.2f", hundredKg));
        binding.tv19InKg.setText(String.valueOf(hundredKgTwoDigits + " किलो"));
        binding.tv19InKgFourthWeek.setText(String.valueOf(hundredKgTwoDigits + " किलो"));
        //Bags Calculation
    ...
    private void valueForCalculation(String input) {
        ...
        //Calculations for 15:15:15
        //First Dose
        double hundredKg = (106.67 * inputFromEditText);
        double hundredKgTwoDigits = Double.parseDouble(String.format("%.2f", hundredKg));
        binding.tv19InKg.setText(String.valueOf(hundredKgTwoDigits + " किलो"));
        binding.tv19InKgFourthWeek.setText(String.valueOf(hundredKgTwoDigits + " किलो"));
        //Bags Calculation
