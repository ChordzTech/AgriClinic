...
import com.example.agroclinic.databinding.ActivityTwelevthTableBinding;

import java.text.DecimalFormat;

public class TwelevthTableActivity extends AppCompatActivity {
   ActivityTwelevthTableBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=DataBindingUtil.setContentView(this,R.layout.activity_twelevth_table);
        initView();
    }
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (!s.toString().isEmpty()) {
                    ...
                    if (binding.rbEkar.isChecked()) {
                        ...
                        Toast.makeText(TwelevthTableActivity.this, "कृपया एकक निवडा", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    binding.etLand.setText("0.0");
                }
    ...
    private void valueForCalculationOfGunta(String input) {
        ...
        //First Dose
        //First Dose
        double hundredKg = (2.0 * inputFromEditText);
        ...
        double minus19 = (fiftyPercentOfPTwoDigits - 6.0);
        ...
        double minus19ForMop = (fiftyPercentOfKTwoDigits - 6.0);
    ...
    private void valueForCalculationOfHector(String input) {
        ...
        //Calculations for 15:15:15
        //First Dose
        double hundredKg = (200.0 * inputFromEditText);
        double hundredKgTwoDigits = Double.parseDouble(String.format("%.2f", hundredKg));
        binding.tv19InKg.setText(String.valueOf(hundredKgTwoDigits + " किलो"));
        binding.tv19InKgFourthWeek.setText(String.valueOf(hundredKgTwoDigits + " किलो"));
        //Bags Calculation
    ...
    private void valueForCalculation(String input) {
        ...
        //Calculations for 15:15:15
        //First Dose
        double hundredKg = (80.0 * inputFromEditText);
        double hundredKgTwoDigits = Double.parseDouble(String.format("%.2f", hundredKg));
        binding.tv19InKg.setText(String.valueOf(hundredKgTwoDigits + " किलो"));
        binding.tv19InKgFourthWeek.setText(String.valueOf(hundredKgTwoDigits + " किलो"));
        //Bags Calculation
