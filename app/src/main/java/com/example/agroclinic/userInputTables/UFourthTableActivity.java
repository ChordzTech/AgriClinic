...
import com.example.agroclinic.databinding.ActivityUfourthTableBinding;

import java.text.DecimalFormat;

public class UFourthTableActivity extends AppCompatActivity {
    ActivityUfourthTableBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_ufourth_table);
        initView();
    }
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (!s.toString().isEmpty()) {
                    ...
                    if (binding.rbEkar.isChecked()) {
                        Toast.makeText(UFourthTableActivity.this, "एकर", Toast.LENGTH_SHORT).show();
                        valueForConditionOfAcer();
                    } else if (binding.rbHector.isChecked()) {
                        valueForConditionCheck();
                        Toast.makeText(UFourthTableActivity.this, "हेक्टर", Toast.LENGTH_SHORT).show();
                    } else if (binding.rbGunta.isChecked()) {
                        Toast.makeText(UFourthTableActivity.this, "गुंठा", Toast.LENGTH_SHORT).show();
                        valueForConditionOfGunta();
                    } else {
                        Toast.makeText(UFourthTableActivity.this, "कृपया एकक निवडा", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private void valueForConditionOfAcer() {
        ...
        } else if (inputFromEditTextN > 281.0) {
        ...
        } else if (inputFromEditTextP >= 3.1 && inputFromEditTextP <= 5.6) {
        ...
        } else if (inputFromEditTextK >= 61.0 && inputFromEditTextK <= 100.0) {
