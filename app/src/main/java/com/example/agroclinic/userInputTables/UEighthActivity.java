...
import com.example.agroclinic.databinding.ActivityUeighthBinding;

import java.text.DecimalFormat;

public class UEighthActivity extends AppCompatActivity {
    ActivityUeighthBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_ueighth);
        initView();
    }
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (!s.toString().isEmpty()) {
                    ...
                    if (binding.rbEkar.isChecked()) {
                        Toast.makeText(UEighthActivity.this, "एकर", Toast.LENGTH_SHORT).show();
                        valueForConditionOfAcer();
                    } else if (binding.rbHector.isChecked()) {
                        valueForConditionCheck();
                        Toast.makeText(UEighthActivity.this, "हेक्टर", Toast.LENGTH_SHORT).show();
                    } else if (binding.rbGunta.isChecked()) {
                        Toast.makeText(UEighthActivity.this, "गुंठा", Toast.LENGTH_SHORT).show();
                        valueForConditionOfGunta();
                    } else {
                        Toast.makeText(UEighthActivity.this, "कृपया एकक निवडा", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private void valueForCalculationGunta(String input) {
        ...
        double minusNFromP = (inputIntoPTwoDigits - 0.4);
        ...
        double minusNFromK = (inputIntoKTwoDigits - 0.4);
...
//        tenPercentOfNTwoDigits
        double minusFortyPFromTenP=(fortyPercentOfNTwoDigits-0.4);
