...
import com.example.agroclinic.databinding.ActivityUtwelthTableBinding;

import java.text.DecimalFormat;

public class UTwelthTableActivity extends AppCompatActivity {
    ActivityUtwelthTableBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_utwelth_table);
        initView();
    }
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (!s.toString().isEmpty()) {
                    ...
                    if (binding.rbEkar.isChecked()) {
                        Toast.makeText(UTwelthTableActivity.this, "एकर", Toast.LENGTH_SHORT).show();
                        valueForConditionOfAcer();
                    } else if (binding.rbHector.isChecked()) {
                        valueForConditionCheck();
                        Toast.makeText(UTwelthTableActivity.this, "हेक्टर", Toast.LENGTH_SHORT).show();
                    } else if (binding.rbGunta.isChecked()) {
                        Toast.makeText(UTwelthTableActivity.this, "गुंठा", Toast.LENGTH_SHORT).show();
                        valueForConditionOfGunta();
                    } else {
                        Toast.makeText(UTwelthTableActivity.this, "कृपया एकक निवडा", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private void valueForCalculationGunta(String input) {
        ...
        double minusNFromP = (inputIntoPTwoDigits - 0.3);
        ...
        double minusNFromK = (inputIntoKTwoDigits - 0.3);
...
//        tenPercentOfNTwoDigits
        double minusFortyPFromTenP = (fortyPercentOfNTwoDigits - 0.3);
